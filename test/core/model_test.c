...
void testRegisterAndRetrieveProxy() {
    ...
    struct IProxy *removedProxy = (struct IProxy *) &(struct Proxy){0};
...
void testRegisterAndRemoveMultipleProxies() {
    ...
    struct IProxy *removedProxy1 = (struct IProxy *) &(struct Proxy){0};
    ...
    struct IProxy *removedProxy3 = (struct IProxy *) &(struct Proxy){0};
    ...
    struct IProxy *removedProxy0 = (struct IProxy *) &(struct Proxy){0};
    ...
    struct IProxy *removedProxy2 = (struct IProxy *) &(struct Proxy){0};
...
void TestModelShiftLeft() {
    ...
    // remove
    puremvc_model_removeModel("model1"); // remove middle, remaining 0, 2, 3
    assert(strcmp(modelMap[0]->key, "model0") == 0);
    assert(strcmp(((struct Model *) modelMap[0]->model)->multitonKey, "model0") == 0);
    ...
    puremvc_model_removeModel("model3"); // remove last, remaining 0, 2
    assert(strcmp(modelMap[0]->key, "model0") == 0);
    assert(strcmp(((struct Model *) modelMap[0]->model)->multitonKey, "model0") == 0);
    assert(strcmp(modelMap[1]->key, "model2") == 0);
    assert(strcmp(((struct Model *) modelMap[1]->model)->multitonKey, "model2") == 0);
    ...
    puremvc_model_removeModel("model0"); // remove first, remaining 2
    ...
    puremvc_model_removeModel("model2"); // remove remaining
    assert(modelMap[0]->key[0] == '\0');
    assert(modelMap[1]->key[0] == '\0');
    assert(modelMap[2]->key[0] == '\0');
    assert(modelMap[3]->key[0] == '\0');
