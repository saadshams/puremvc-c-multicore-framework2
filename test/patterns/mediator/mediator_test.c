...
void testConstructor() {
    const struct IMediator *mediator = puremvc_mediator_init((struct IMediator *) &(struct Mediator){0}, NULL, NULL);
...
void testNameAccessor() {
    const struct IMediator *mediator = puremvc_mediator_init((struct IMediator *) &(struct Mediator){0}, "TestMediator", NULL);
...
void testViewAccessor() {
    ...
    struct IMediator *mediator = puremvc_mediator_init((struct IMediator *) &(struct Mediator){0}, MEDIATOR_NAME, &component);
