...
void testConstructor() {
    const struct IMediator *mediator = puremvc_mediator_init(&(struct Mediator){0}.base, NULL, NULL);
...
void testNameAccessor() {
    const struct IMediator *mediator = puremvc_mediator_init(&(struct Mediator){0}.base, "TestMediator", NULL);
...
void testViewAccessor() {
    ...
    struct IMediator *mediator = puremvc_mediator_init(&(struct Mediator){0}.base, MEDIATOR_NAME, &component);
