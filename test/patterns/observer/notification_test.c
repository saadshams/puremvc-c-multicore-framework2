...
void testBodyAccessors() {
    ...
    // Create a new Notification and use accessors to set the body
    struct INotification *notification = puremvc_notification_init(alloca(puremvc_notification_size("TestNote", NULL)), "TestNote", NULL, NULL);
...
void testTypeAccessors() {
    struct INotification *notification = puremvc_notification_init(alloca(puremvc_notification_size("TestNote", "TestNoteType")), "TestNote", NULL, "TestNoteType");
...
void testToString() {
    ...
    const struct INotification *notification = puremvc_notification_init(alloca(puremvc_notification_size("TestNote", "TestNoteType")), "TestNote", NULL, "TestNoteType");
